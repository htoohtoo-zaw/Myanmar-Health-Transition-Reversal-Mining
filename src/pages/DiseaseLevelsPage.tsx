    ...
    <div className="space-y-6">
      ...
      {activeTab === 'heatmap' ? (
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 mb-3">
              ...
              <div className="flex items-center gap-4 text-[12px]">
                <div className="flex items-center gap-1.5">
                  ...
                  <span className="font-medium text-[var(--c-ink)]">Low Burden</span>
                </div>
                <div className="flex items-center gap-1.5">
                  <span className="w-3 h-3 rounded-sm bg-[var(--c-warning)]" />
                  <span className="font-medium text-[var(--c-ink)]">Mid Burden</span>
                </div>
                <div className="flex items-center gap-1.5">
                  <span className="w-3 h-3 rounded-sm bg-[var(--c-danger)]" />
                  <span className="font-medium text-[var(--c-ink)]">High Burden</span>
                </div>
              </div>
            </div>
            ...
            <div className="overflow-x-auto pb-2">
              <div className="min-w-[760px]">
                ...
                <div className="grid grid-cols-[180px_repeat(25,1fr)] gap-1 mb-1 items-center">
                  <div className="text-[11px] font-semibold text-[var(--c-muted)] uppercase tracking-wider pl-1">
                    Disease Name
                  </div>
                  {years.map((y) => (
                    <div
                ...
                <div className="space-y-1">
                  {DISEASE_LEVELS_DATA.map((row) => (
                    ...
                    >
                      <div className="text-[12px] font-medium text-[var(--c-ink)] truncate pr-2" title={row.disease}>
                        {row.disease}
                      </div>
            ...
            <div className="mt-3 p-2.5 rounded-[6px] bg-[var(--c-subtle)] border border-[var(--c-border-strong)] flex items-center justify-between text-[12px]">
              {hoveredCell ? (
                <div>
                  ...
                  <span className="text-[var(--c-muted)] ml-2">
                    (Observation: {hoveredCell.val} {hoveredCell.unit})
                  </span>
                </div>
              ) : (
                <div className="text-[var(--c-muted)] italic">
                  Hover over any heatmap block to view exact raw historical indicator values.
                </div>
              )}
              <span className="text-[11px] font-mono text-[var(--c-primary)]">
              ...
              <table className="w-full text-left text-[13px]">
                <thead>
                  <tr className="border-b border-[var(--c-border)] text-[var(--c-muted)]">
                    ...
                    <th className="py-2.5 px-3 font-medium text-[var(--c-success)]">Low Max Cut</th>
                    <th className="py-2.5 px-3 font-medium text-[var(--c-warning)]">Mid Max Cut</th>
                    <th className="py-2.5 px-3 font-medium text-[var(--c-danger)]">High Threshold</th>
                  </tr>
                </thead>
                  ...
                  {DISEASE_LEVELS_DATA.map((d) => {
                    ...
                    return (
                      <tr key={d.code} className="hover:bg-[var(--c-subtle)]/40">
                        ...
                        <td className="py-2.5 px-3 text-[var(--c-muted)]">{d.category}</td>
                        <td className="py-2.5 px-3 text-[var(--c-muted)] font-mono">{d.unit}</td>
        ...
        <div className="bg-[var(--c-surface)] border border-[var(--c-border)] rounded-[8px] p-5 shadow-[var(--c-shadow-sm)] space-y-4">
          <div>
            <h3 className="text-[17px] font-bold text-[var(--c-ink)]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="p-4 rounded-[8px] border border-[var(--c-border-strong)] bg-[var(--c-subtle)]/40">
              <h4 className="text-[14px] font-bold text-[var(--c-primary)] mb-2">
                Level Sequence Clustering (Ordinal Transitions)
              </h4>
              <p className="text-[12px] text-[var(--c-ink)] leading-relaxed mb-3">
