      ...
      <div className="bg-[var(--c-surface)] border border-[var(--c-border)] rounded-[8px] p-5 shadow-[var(--c-shadow-sm)]">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 mb-4">
          ...
          <div className="flex items-center gap-2">
            <span className="text-[11px] font-mono px-2.5 py-1 rounded bg-[var(--c-subtle-2)] text-[var(--c-primary)] border border-[var(--c-border-strong)] font-semibold">
              Threshold Cut: k = 3
            </span>
          </div>
        </div>
        ...
        <div className="relative w-full overflow-x-auto pb-2">
          <div className="min-w-[640px] bg-[var(--c-subtle)]/40 rounded-[8px] p-4 border border-[var(--c-border-strong)]">
            ...
            <div className="relative mb-2 flex items-center justify-between text-[11px] font-mono text-[var(--c-danger)]">
              <span className="bg-[var(--c-surface)] px-2 py-0.5 rounded border border-[var(--c-danger)]/40">
            ...
            <svg viewBox="0 0 700 180" className="w-full h-[180px]">
              ...
              <g className="cursor-pointer" onClick={() => setSelectedCluster(3)}>
                ...
                <text x="120" y="152" textAnchor="middle" fontSize="11" fontWeight="bold" fill={selectedCluster === 3 ? colors.surface : colors.success}>
                  Cluster 3 (n=5)
                </text>
                <text x="120" y="165" textAnchor="middle" fontSize="9" fill={selectedCluster === 3 ? colors.surface : colors.muted}>
                  Secular Reductions
                </text>
              </g>
              ...
              <g className="cursor-pointer" onClick={() => setSelectedCluster(1)}>
                ...
                <text x="350" y="152" textAnchor="middle" fontSize="11" fontWeight="bold" fill={selectedCluster === 1 ? colors.surface : colors.primary}>
                  Cluster 1 (n=7)
                </text>
                <text x="350" y="165" textAnchor="middle" fontSize="9" fill={selectedCluster === 1 ? colors.surface : colors.muted}>
              ...
              <g className="cursor-pointer" onClick={() => setSelectedCluster(2)}>
                ...
                <text x="570" y="152" textAnchor="middle" fontSize="11" fontWeight="bold" fill={selectedCluster === 2 ? colors.surface : colors.danger}>
                  Cluster 2 (n=5)
                </text>
                <text x="570" y="165" textAnchor="middle" fontSize="9" fill={selectedCluster === 2 ? colors.surface : colors.muted}>
          ...
          return (
            ...
            >
              ...
              <div className="border-t border-[var(--c-border)] pt-3">
                <div className="text-[11px] font-semibold text-[var(--c-muted)] uppercase tracking-wider mb-2">
                  Member Indicators:
                </div>
            ...
            <table className="w-full text-left text-[13px]">
              <thead>
                <tr className="border-b border-[var(--c-border)] text-[var(--c-muted)]">
                  ...
                  <th className="py-2.5 px-3 font-medium text-center text-[var(--c-primary)]">
                    Cluster 1 (Halving Shock)
                  </th>
                  <th className="py-2.5 px-3 font-medium text-center text-[var(--c-danger)]">
                    Cluster 2 (Reversals)
                  </th>
                  <th className="py-2.5 px-3 font-medium text-center text-[var(--c-success)]">
                    Cluster 3 (Secular)
                  </th>
              ...
              <tbody className="divide-y divide-[var(--c-border)]">
                {CROSS_TAB_CLUSTERING.map((r, i) => (
                  <tr key={i} className="hover:bg-[var(--c-subtle)]/40">
                    <td className="py-2 px-3 font-medium text-[var(--c-ink)]">{r.domain}</td>
